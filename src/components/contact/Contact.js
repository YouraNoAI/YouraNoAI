...
const Contact = () => {
  const TELEGRAM_BOT_TOKEN = "7055417576:AAHBT8WyAVgep5y51KVtvqe816qx_UnvgEQ";
  const TELEGRAM_CHAT_ID = "6377993068";
  ...
  const sendEmailViaTelegram = async () => {
    const text = `
📧 New Contact Email
          ...
          <div className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne">
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
              ...
              <div className="flex flex-col gap-4">
                ...
                <input onChange={(e) => setSubject(e.target.value)} value={subject} className={`${errMsg === "Plese give your Subject!" && "outline-designColor"} contactInput`} type="text" />
              </div>
              <div className="flex flex-col gap-4">
